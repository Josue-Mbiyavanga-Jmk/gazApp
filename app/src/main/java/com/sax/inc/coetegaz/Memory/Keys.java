...
public class Keys {
    ...
    public static class PreferencesKeys {
        ...
        public static final String LAST_DATE_DEMANDE = "LAST_DATE_DEMANDE";

        public static final String UID = "UID";
        public static final String PROFIL_USER = "PROFIL_USER";
        public static final String FINISH_AUTH = "FINISH_AUTH";
        public static final String STORE_ID_NAT= "STORE_ID_NAT";
        public static final String STORE_ID_AGENCE= "STORE_ID_NAT";
        public static final String STORE_NAME_AGENCE= "STORE_NAME_AGENCE";
        public static final String STORE_PSEUDO_USER = "STORE_PSEUDO_USER";
        public static final String STORE_ID_USER = "STORE_ID_USER";
        ...
        public static final String ENTITE_REFERENCE_FIRESTORE = "ENTITE_REFERENCE_FIRESTORE";
    }
