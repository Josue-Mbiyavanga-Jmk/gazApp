...
public class RecylerAdapterListAgence extends RecyclerView.Adapter<RecylerAdapterListAgence.ViewHolder> {
    ...
    public RecylerAdapterListAgence(AppCompatActivity appCompatActivity, List<EAgence> items, ItemButtonListener callback) {
        this.items = items;
        this.activity=appCompatActivity;
        callback_click=callback;
    }

    public RecylerAdapterListAgence(AppCompatActivity appCompatActivity, List<EAgence> items, LatLng myposition, ItemButtonListener callback) {
        this.items = items;
        this.activity=appCompatActivity;
        callback_click=callback;
    ...
    @Override
    public RecylerAdapterListAgence.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                              int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_agences_liste, parent, false);
